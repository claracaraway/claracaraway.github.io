...
[Linked in python scrape](https://towardsdatascience.com/mining-data-on-linkedin-9b70681b1467)
...
[VG_CLEAN](file:///Users/kendraryan/Projects/virgin_galactic/VG_CLEAN_barsWORKING.html)

[python - Matplotlib - Move text label right by x points - Stack Overflow](https://stackoverflow.com/questions/54652843/matplotlib-move-text-label-right-by-x-points)

[Legend guide — Matplotlib 3.3.2 documentation](https://matplotlib.org/tutorials/intermediate/legend_guide.html)

[US Cities Database | Simplemaps.com](https://simplemaps.com/data/us-cities)

[ca_city_df = city_df.copy() - Google Search](https://www.google.com/search?q=ca_city_df+=+city_df.copy()&rlz=1C5CHFA_enUS905US905&oq=ca_city_df+=+city_df.copy()&aqs=chrome..69i57.421j0j7&sourceid=chrome&ie=UTF-8)
...
[california fips - Google Search](https://www.google.com/search?q=california+fips&rlz=1C5CHFA_enUS905US905&oq=california+fips&aqs=chrome..69i57.1502j0j7&sourceid=chrome&ie=UTF-8)
